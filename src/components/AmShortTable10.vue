        ...
        <div class="body border-left border-right border-bottom">
            ...
            <div class="body-row">
                <div class="body-row-content">
                    ...
                    <el-input class="body-row-content" v-model="localtable[0].WAVELEVELONE" placeholder="请输入浪高" :disabled="!editable" @change="checkSubmit"></el-input>
                    <div class="four-words">&nbsp;&nbsp;米&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;的&nbsp;&nbsp;</div>
                    <el-input class="body-row-content" v-model="localtable[0].WAVELEVELTYPE" placeholder="请输入浪高描述" :disabled="!editable" @change="checkSubmit"></el-input>
                    <div class="one-word"></div>
                </div>
            </div>
            <div class="body-row">
                <div class="body-row-content">
                    ...
                    <el-input class="body-row-content" v-model="localtable[0].WAVEDIRECTION" placeholder="请输入风浪向" :disabled="!editable" @change="checkSubmit"></el-input>
                    <div class="one-word"></div>
                </div>
            </div>
            <div class="body-row">
                <div class="body-row-content">
                    ...
                    <el-input class="body-row-content" v-model="localtable[0].WATERTEMPERATURE" placeholder="请输入水温" :disabled="!editable" @change="checkSubmit"></el-input>
                    <div class="one-word">℃</div>
                    <div class="one-word"></div>
                </div>
            </div>
